...
export const paymentTypeEnum = pgEnum("payment_type", paymentTypeValues)
...
export const appointments = pgTable("appointments", {
  ...
  customerServicePackageId: uuid("customer_service_package_id").references(
...
export const appointmentsRelations = relations(appointments, ({ one }) => ({
  ...
  customerServicePackage: one(customerServicePackages, {
    fields: [appointments.customerServicePackageId],
    references: [customerServicePackages.id],
    relationName: "customerServicePackageAppointments",
  }),
}))
